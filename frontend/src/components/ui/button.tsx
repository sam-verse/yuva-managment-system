  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "btn-gradient-primary hover:scale-[1.02] active:scale-[0.98] font-semibold",
        "gradient-accent": "btn-gradient-accent hover:scale-[1.02] active:scale-[0.98] font-semibold",
        ...
        professional: "bg-gradient-to-r from-primary to-primary-hover text-primary-foreground shadow-floating hover:shadow-glow hover:scale-[1.02] transition-all duration-300",
        glass: "backdrop-blur-sm bg-background/80 border border-border/50 hover:bg-background/90 shadow-elegant"
      },
      size: {
